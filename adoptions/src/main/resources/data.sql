...
VALUES (97, 'Rocky', 'A brown Chihuahua known for being protective.'),
       ...
       (102, 'Bobby', 'A shabby gray cat that hates other dogs.'),
       (103, 'Aristocat', 'A red half breed dog that loves other dogs.'),
       ...
       (59, 'Bull', 'A very big grand danois dog that can run very fast.'),
